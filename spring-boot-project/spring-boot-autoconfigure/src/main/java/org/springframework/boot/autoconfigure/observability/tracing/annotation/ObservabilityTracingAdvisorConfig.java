...
public class ObservabilityTracingAdvisorConfig extends AbstractPointcutAdvisor implements BeanFactoryAware {
...
class SleuthInterceptor implements IntroductionInterceptor, BeanFactoryAware {
	...
	private TracingMethodInvocationProcessor methodInvocationProcessor;
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		NewSpan newSpan = ObservabilityTracingAnnotationUtils.findAnnotation(mostSpecificMethod, NewSpan.class);
		ContinueSpan continueSpan = ObservabilityTracingAnnotationUtils.findAnnotation(mostSpecificMethod, ContinueSpan.class);
	...
	private TracingMethodInvocationProcessor methodInvocationProcessor() {
		if (this.methodInvocationProcessor == null) {
			this.methodInvocationProcessor = this.beanFactory.getBean(TracingMethodInvocationProcessor.class);
		}
