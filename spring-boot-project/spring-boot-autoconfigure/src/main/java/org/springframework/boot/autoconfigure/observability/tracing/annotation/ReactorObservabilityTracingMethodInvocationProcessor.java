...
public class ReactorObservabilityTracingMethodInvocationProcessor extends AbstractObservabilityTracingMethodInvocationProcessor {

	private NonReactorObservabilityTracingMethodInvocationProcessor nonReactorSleuthMethodInvocationProcessor;
	...
	private NonReactorObservabilityTracingMethodInvocationProcessor nonReactorSleuthMethodInvocationProcessor() {
		if (this.nonReactorSleuthMethodInvocationProcessor == null) {
			this.nonReactorSleuthMethodInvocationProcessor = new NonReactorObservabilityTracingMethodInvocationProcessor();
	...
	private static final class FluxSpan extends FluxOperator<Object, Object> {
		...
		final ReactorObservabilityTracingMethodInvocationProcessor processor;

		final NewSpan newSpan;

		FluxSpan(Flux<Object> source, ReactorObservabilityTracingMethodInvocationProcessor processor, NewSpan newSpan,
		...
		public void subscribe(CoreSubscriber<? super Object> actual) {
			...
			if (this.span == null) {
				...
				span = ObservabilityTracingAnnotationSpan.ANNOTATION_NEW_OR_CONTINUE_SPAN.wrap(tracer.nextSpan());
...
//	private static final class MonoSpan extends MonoOperator<Object, Object> implements TraceContextPropagator {
	private static final class MonoSpan extends MonoOperator<Object, Object> {
		...
		MonoSpan(Mono<Object> source, ReactorObservabilityTracingMethodInvocationProcessor processor, NewSpan newSpan,
				@Nullable Span span, MethodInvocation invocation, String log) {
			super(source);
			this.processor = processor;
			this.newSpan = newSpan;
	...
	private static final class SpanSubscriber implements CoreSubscriber<Object>, Subscription, Scannable {
		...
		SpanSubscriber(CoreSubscriber<? super Object> actual, ReactorObservabilityTracingMethodInvocationProcessor processor,
