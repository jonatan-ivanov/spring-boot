...
final class AnyTracerModePropertySetCondition extends AnyNestedCondition {
	...
	@ConditionalOnProperty(value = "spring.observability.tracing.tracer.mode", havingValue = "AUTO", matchIfMissing = true)
	static class OnAutoTracerMode {

	}

	@ConditionalOnProperty(value = "spring.observability.tracing.tracer.mode", havingValue = "BRAVE")
