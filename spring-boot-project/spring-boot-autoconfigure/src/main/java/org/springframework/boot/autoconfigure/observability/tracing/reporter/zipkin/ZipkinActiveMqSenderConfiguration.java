...
@ConditionalOnProperty(value = "spring.observability.tracing.zipkin.sender.type", havingValue = "activemq")
...
class ZipkinActiveMqSenderConfiguration {
	...
	static class ZipkinActiveMqSenderBeanConfiguration {
		...
		@Value("${spring.observability.tracing.zipkin.activemq.queue:zipkin}")
		private String queue;

		@Value("${spring.observability.tracing.zipkin.activemq.message-max-bytes:100000}")
