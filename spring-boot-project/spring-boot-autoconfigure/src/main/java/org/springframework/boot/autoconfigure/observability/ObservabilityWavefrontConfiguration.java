...
import org.springframework.boot.autoconfigure.observability.reporter.wavefront.WavefrontBraveSpanHandler;
import org.springframework.boot.autoconfigure.observability.reporter.wavefront.WavefrontSpringObservabilitySpanHandler;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;

@Configuration(proxyBeanMethods = false)
@ConditionalOnClass({ MeterRegistry.class, WavefrontConfig.class, WavefrontSender.class })
class ObservabilityWavefrontConfiguration {
