...
import static org.springframework.boot.autoconfigure.observability.tracing.reporter.zipkin.ZipkinSenderConfigurationImportSelector.getType;
...
class ZipkinSenderCondition extends SpringBootCondition {
	...
	public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata md) {
		...
		String property = context.getEnvironment().getProperty("spring.observability.tracing.zipkin.sender.type");
